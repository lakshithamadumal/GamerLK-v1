        ...
        <div class="row">
            ...
            <ul class="navbar" id="navbar">
                    <li class="d-none d-lg-block">
                        <a class="active" href="home.php"><i class="fa-solid fa-house fa-xl "></i></a>
                    </li>
                    <li class="d-lg-none">
                        <a class="active" href="home.php"><i class="fa-solid fa-house fa-lg "></i> &nbsp; Home</a>
                    </li>
            ...
            <div class="modal-content bg-dark">
                            ...
                            <div class="col-8 rounded bg-success">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-end pb-2">
                                        <span class="text-white fs-8">2022-11-9 00:00:00</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-9">
                                <input type="text" class="form-control fw-bold" id="msgtxt" />
                            </div>
