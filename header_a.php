            ...
            <div>
                ...
                <ul class="navbar" id="navbar">
                    <li class="d-none d-lg-block">
                        <a class="active" href="adminPanel.php"><i class="fa-solid fa-house fa-xl"></i></a>
                    </li>
                    <li class="d-lg-none">
                        <a class="active" href="adminPanel.php"><i class="fa-solid fa-house fa-lg"></i> &nbsp; Dashboard</a>
                    </li>


                    <li class="d-none d-lg-block">
                        <a href="myProducts.php"><i class="fa-solid fa-list fa-xl"></i></a>
                    </li>
                    <li class="d-lg-none">
                        <a href="myProducts.php"><i class="fa-solid fa-list fa-lg"></i> &nbsp; Products</a>
                    </li>
